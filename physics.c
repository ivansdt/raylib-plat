...
groundTile tiles[] = {
    {{0.0, 320.0}, {84.0, 42.0}},
    {{-100.0, 120.0}, {42.0, 130.0}},
    {{80.0, 85.0}, {140.0, 42.0}},
    {{300.0, -120.0}, {210.0, 140.0}},
    {{650.0, -1640.0}, {84.0, 1500.0}},
    {{220.0, -450.0}, {240.0, 42.0}},
    {{100.0, -2040.0}, {42.0, 1500.0}},
    {{300.0, -690.0}, {120.0, 42.0}},
    {{320.0, -1050.0}, {60.0, 42.0}},
    {{470.0, -1280.0}, {70.0, 160.0}},
    {{734.0, -1640.0}, {300.0, 200.0}}};
